...
export const translations = {
  ...
  ru: {
    ...
    projects: {
      ...
      items: [
        {
          title: "Платформа онлайн-бронирования ПК",
          shortDescription: "Онлайн бронирование , и просмотр доступных слотов",
          fullDescription:
            "Разработана современная онлайн-система бронирования для игрового клуба, позволяющая пользователям заранее резервировать компьютеры, просматривать доступные временные интервалы и управлять своими бронированиями. ",
