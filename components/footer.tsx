...
import { Github, Linkedin, Dribbble, Heart, Sparkles, ArrowUp } from 'lucide-react'
import { useLanguage } from '@/lib/language-context'
import { cn } from '@/lib/utils'

const socialLinks = [
  { name: 'GitHub', url: 'https://github.com', icon: Github, color: 'hover:bg-gray-900 hover:text-white dark:hover:bg-white dark:hover:text-gray-900' },
  { name: 'LinkedIn', url: 'https://linkedin.com', icon: Linkedin, color: 'hover:bg-blue-600 hover:text-white' },
  { name: 'Dribbble', url: 'https://dribbble.com', icon: Dribbble, color: 'hover:bg-pink-500 hover:text-white' },
]
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              >
                ...
                <span className="text-foreground group-hover:text-primary transition-colors">Portfolio</span>
              </a>
              <p className="text-muted-foreground leading-relaxed max-w-xs">
                {t.language === 'en' 
                  ? 'Creating digital experiences that inspire and delight users.'
                  : 'Создаю цифровые впечатления, которые вдохновляют и радуют пользователей.'
                }
              </p>
            </div>
            ...
            <div>
              <h3 className="font-semibold text-foreground mb-4" style={{ fontFamily: 'var(--font-heading)' }}>
                {t.language === 'en' ? 'Quick Links' : 'Быстрые ссылки'}
              </h3>
            ...
            <div>
              <h3 className="font-semibold text-foreground mb-4" style={{ fontFamily: 'var(--font-heading)' }}>
                {t.language === 'en' ? 'Connect' : 'Связаться'}
              </h3>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            >
              <span className="text-sm font-medium">
                {t.language === 'en' ? 'Back to top' : 'Наверх'}
              </span>
